...
from(select *,
       ...
       compras_entregas.dt_confirmada, case when compras_entregas.dt_confirmada is null then compras.dt_entrega else compras_entregas.dt_confirmada end as dtentrega
