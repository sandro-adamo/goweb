...
<div class="wrapper">
        ...
        $itens = \DB::select("select * from itens where secundario like '$modelo%'");
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>GO</b></span>
    </a>
        ...
        <span class="icon-bar"></span>
          ...
          <form class="navbar-form navbar-left" role="search">
            <div class="form-group">
              <input type="text" autofocus name="modelo" class="form-control" id="navbar-search-input" placeholder="Search">
            </div>
          </form>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget">
			...
			<table class="col-md-10">
					  ...
					  <td>{{$item->colmod}}</td>
					  <td>{{$item->valortabela}}</td>
					   <td>{{$item->ultstatus}}</td>
				  	</tr>
			</table>
