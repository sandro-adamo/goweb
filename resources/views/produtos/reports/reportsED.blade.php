...
@php
$sql = DB::select("select Agrupamento, sum(Atende_Disp) Atende_Disp, sum(Atende_TO) Atende_TO, sum(Atende_CET) Atende_CET, sum(Atende_ETQ) Atende_ETQ, sum(Atende_CEP) Atende_CEP, sum(Total_Atende) Total_Atende, sum(Orc_Pendente) Orc_Pendente
...
@endphp
    ...
    <script type="text/javascript">
      ...
      function drawTable() {
		...
		<div id="table_div" style="width: 900px; height: 900px;"></div>         
