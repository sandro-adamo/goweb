...
$query = DB::select(
	...
	from sugestoes where agrup = '$agrup' ) as base
	order by genero asc, idade, material, clas_mod, clas_item  
");
    ...
    <div class="box box-widget">
      ...
      <div class="box-body">  
       <table class="table table-bordered table-condensed">
        ...
        <tr align="center">
          <td width="3%">Gender</td> 
          <td width="3%">Age</td> 
          <td width="3%">Material</td>
        ...
        <tr> 
         <td align="center"><small><?php echo $dados->genero?> </small></td>
         <td align="center"><small><?php echo $dados->idade?> </small></td>
         <td align="center"><small><?php echo $dados->material?> </small></td>
