...
@section('title')
<i class="fa fa-group"></i> Detalhamento do Pedido @if (isset($_GET["pedido"])) {{$_GET["pedido"]}} @endif
@append 
...
@php
    ...
    $query1 = \DB::select("
select * from portal_pedidos  where pedido = '$pedido' and desc_status not in ('Backorder', 'cancelado')  order by pedido  ");
