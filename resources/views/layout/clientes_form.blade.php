						...
						<table class="table table-bordered" id="example3">
							<thead>
								...
								<tr>	
									...
									<td colspan="1" align="center" text="red">gerar catalogo - em desenvolvimento</td>
						  </thead>	
							</tr>
								...
								<tr>
									...
									<td align="left">					
										...
										<select name="motivos{{$query1->grife}}">
											...
											<option value="gosac">Problemas com Cobranca</option>
											<option value="gosac">Problemas com Logistica</option>
											<option value="gosac">Problemas com Trade/MPDV</option>
											<option value="gosac">Compra por outro codigo</option>
