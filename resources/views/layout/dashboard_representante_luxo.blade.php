          ...
          <div class="col-md-8">
            ...
            <div class="row">
              ...
              @php
                ...
                $qtdegrifes = \DB::select("select grife_jde, count(cliente) clientes, sum(qtde) qtde from ( 
        
    select cliente, grife_jde, sum(qtde) qtde, sum(valor) valor from (
      ...
      where tipo = '2018' and grife_jde in ('AH','AT','BG','EV','HI','JO','SP','TC','NG') $sql
              ...
              @foreach ($qtdegrifes as $a)
                ...
                @endif 
                  ...
                  <td align="center" class="text-bold">{{$a->grife_jde}}</td>
...
limit 10");
    ...
    <div class="box box-widget">
      <div class="box-header with-border">
        ...
        <span class="pull-right"><a href="/dashboard/exportaClientes" class="pull-right"><i class="fa fa-file-o"></i> Exporta</a></span>
      </div>
