...
$nossonumero = formata_numero(substr($dadosboleto["nosso_numero"],0,-1),11,0);

//$nnum = formata_numero(substr($dadosboleto["nosso_numero"],0,11),11,0);

//nosso número (sem dv) é 11 digitos
//$nnum = formata_numero($dadosboleto["carteira"],2,0).formata_numero($nnum,11,0);
$nnum = formata_numero($dadosboleto["carteira"],2,0).$nossonumero;

//dv do nosso número
//$dv_nosso_numero = digitoVerificador_nossonumero($nnum);
// $dv_nosso_numero = formata_numero(substr($dadosboleto["nosso_numero"],11,1),1,0);
$dv_nosso_numero = substr(formata_numero($dadosboleto["nosso_numero"],12,0),11,1);
...
// echo "$codigobanco.$nummoeda.$fator_vencimento.$valor.$agencia.$nnum.$conta_cedente";
// dd($dv);
