...
$nossonum = substr($dadosboleto["nosso_numero"],0,-1);
//nosso número (sem dv) é 11 digitos
$nnum = formata_numero($dadosboleto["carteira"],2,0).formata_numero($nossonum,11,0);

//dd($nnum);
//dv do nosso número
$dv_nosso_numero = digitoVerificador_nossonumero($nnum);
//$dv_nosso_numero = formata_numero($dadosboleto["carteira"],1,0);
