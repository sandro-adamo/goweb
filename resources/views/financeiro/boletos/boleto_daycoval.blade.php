...
$dadosboleto["numero_documento"] = trim('0'.$boleto->titulo.substr($boleto->parcela,1,2));	// Num do pedido ou do documento = Nosso numero
...
$juros_mora = $boleto->mora /100;


$dt_juros = date('d/m/Y', strtotime("+1 days",strtotime($boleto->vencimento)));  

// INFORMACOES PARA O CLIENTE
$dadosboleto["demonstrativo1"] = "";
$dadosboleto["demonstrativo2"] = "";
$dadosboleto["demonstrativo3"] = "";
$dadosboleto["instrucoes1"] = "MORA DE $juros_mora AO DIA A PARTIR DE $dt_juros";
...
// NÃO ALTERAR!
include("../resources/views/financeiro/boletos/include/funcoes_bradesco.php");
