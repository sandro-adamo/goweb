<?php
	...
	function consultaFoto($referencia) {
		...
		$foto_baixa1 	= $link.'fotos/BAIXA/'.trim($produto["agrupamento"]).'/'.trim($produto["item2"]).'.jpg';
		$foto_baixa2 	= $link.'fotos/BAIXA/'.trim($produto["agrupamento"]).'/'.trim($produto["item2"]).'.JPG';
		$link.
		$foto_alta1 	= $link.'fotos/ALTA/'.trim($produto["agrupamento"]).'/'.trim($produto["item2"]).'.jpg';
		$foto_alta2 	= $link.'fotos/ALTA/'.trim($produto["agrupamento"]).'/'.trim($produto["item2"]).'.JPG';
		$link.
		$foto_modelo1 	= $link.'fotos/BAIXA/'.trim($produto["agrupamento"]).'/'.trim($produto["modelo"]).'.JPG';
$link.
		$foto_modelo2 	= $link.'fotos/BAIXA/'.trim($produto["agrupamento"]).'/'.trim($produto["modelo"]).'.jpg';
$link.
